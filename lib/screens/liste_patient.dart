...
//import '../screens/voir_patient.dart';
...
class ListePatientsPage extends StatefulWidget {
  ...
  @override
  _ListePatientsPageState createState() => _ListePatientsPageState();
}
...
class _ListePatientsPageState extends State<ListePatientsPage> {
  ...
  Widget build(BuildContext context) {
    return CustomBackground(
      selectedMenu: "Liste des patients",
        ...
        children: [
          ...
          Positioned(
            ...
            child: Padding(
              padding: const EdgeInsets.all(16.0),
              child: Text(
                'Total des patients: ${filteredPatients.length}',
...
/*// Icône en haut à droite
        Positioned(
          ...
          left: 20,
          child: SvgPicture.asset(
            'assets/images/userf.svg', // Remplace par le chemin correct
            width: 60,
            height: 60,
          ),
        ),

        // Bouton Voir en haut à gauche
        Positioned(
          top: 25,
          right: 25,
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor:
                  const Color(0xFFFFB800).withOpacity(0.9), // Couleur du bouton
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(30),
              ),
            ),
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      PatientDetailPage(), // Naviguer vers une page de détail
                ),
              );
            },
            child: Text(
